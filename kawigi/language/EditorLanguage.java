...
public abstract class EditorLanguage
{
    ...
    {       
        //<vexorian> Test case mod
        // Print the test number
        print().text("\"\\033[1;36mTest \"").printAdd().text(sTestNumVarName)
                                 .printAdd().text("\"\\033[0m: [\"");
        //</vexorian>
    ...
    private void printTestOutputInfo()
    {
        ...
        /*<vexorian> Some mods: Change order, now assigns res before
                    showing desired answer, only show desired answer
                     if it is different
        */
    ...
    private void makeTestCaller()
    {
        ...
        funcDefPostfix(EditorDataType.Boolean);
            ...
            // <vexorian> Print big separator
            println().text("\"\\033[0;2m===============================================================\\033[0m\"").endPrintln();
            // </vexorian>
    ...
    private void mainSub()
    {
        mainSubDef();
            ...
            // Check if all is OK.
            // <vexorian> Better messages
            iff().text(sMainResVarName).then();
                iff().text(sMainOneDisabledName).then();
                    println().text("\"\\033[1;32mSeems OK\\033[0m (Some tests were \\033[0;41mdisabled\\033[0m though)\"").endPrintln();
                els();
                    println().text("\"\\033[1;32mSeems OK (... Is it?)\\033[0m\"").endPrintln();
                endIf();
            els();
                println().text("\"\\033[0;41mSome of the test cases had errors.\\033[0m\"").endPrintln();
            endIf();
            // </vexorian>
            // We are done
        endMainSub();
